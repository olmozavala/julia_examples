...
@time res = DiffEqFlux.sciml_train(loss, pinit, ADAM(0.05), maxiters = 100)
@time res2 =  DiffEqFlux.sciml_train(loss, res.minimizer, BFGS(initial_stepnorm=0.01), maxiters = 100)
